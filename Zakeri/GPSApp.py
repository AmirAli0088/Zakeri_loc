...
EMAIL_ADDRESS = "amirhoseinzakeri997@gmail.com"  # ایمیل شما
EMAIL_PASSWORD = "lzyg nhnh qtno jrpr"  # رمز عبور ایجاد شده در Google App Passwords
TO_EMAIL = "amirhoseinzakeri997@gmail.com"  # ایمیلی که موقعیت به آن ارسال شود (می‌تواند متفاوت باشد)
